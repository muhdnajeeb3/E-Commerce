...
function Rating(props) {
  ...
  return (
    <div className="rating">
        ...
        <span><i className={ rating >=3 ? 'fa fa-star':rating>=2.5 ? 'fa fa-star-half-0':'fa fa-star-0'}></i></span>
        <span><i className={ rating >=4 ? 'fa fa-star':rating>=3.5 ? 'fa fa-star-half-0':'fa fa-star-0'}></i></span>
